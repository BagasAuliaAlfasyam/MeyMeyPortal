...
class MahasiswaController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.mahasiswa.create', compact('program_studies', 'data_user'));
    }
    ...
    public function store(MahasiswaRequest $request)
    {
        if($request->validated()) {
            ...
            // User::create($request->except('nama_lengkap', 'email', 'password') + ['nama_lengkap' => $nama, 'email' => $email, 'password' => $password_hash]);
        }
