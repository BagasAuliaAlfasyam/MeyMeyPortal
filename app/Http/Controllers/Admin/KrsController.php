...
class KrsController extends Controller
{
    ...
    public function find(Request $request)
    {
        ...
        ->where('krs.nim', '=', $request->nim, 'and', 'krs.tahun_akademik_id', '=', $request->tahun_akademik_id)
        ->get();
    ...
    public function create($nim, $tahun_akademik_id)
    {
        ...
        return view('admin.krs.create', compact('nim', 'tahun_akademik', 'data_mata_kuliah', 'mhs'));
    }
