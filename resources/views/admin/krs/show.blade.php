...
@section('content')
  ...
  <div class="content-header">
    <div class="container-fluid">
      ...
      <a href="{{ route('admin.krs.create', [$data_krs['nim'], $data_krs['tahun_akademik_id']]) }}" class="btn btn-sm btn-primary"> <i
          class="fa fa-plus fa-sm"></i> Tambah Data</a>
        ...
        @foreach ($data_krs['select_krs'] as $krs)
          <tr>
            ...
            <td>
              ...
              <form onclick="return confirm('are you sure ?');" class="d-inline-block" action="{{ route('admin.krs.destroy', $krs->id) }}"
                method="post">
                @csrf
                @method('delete')
