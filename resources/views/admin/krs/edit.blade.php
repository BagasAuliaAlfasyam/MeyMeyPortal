              ...
              <div class="form-group row border-bottom pb-4">
                ...
                <div class="col-sm-10">
                  <select readonly class="form-control" name="tahun_akademik_id" id="tahun_akademik_id">
                    <option readonly value="{{ $krs->tahun_akademik->id }}"> {{ $krs->tahun_akademik->tahun_akademik . $krs->tahun_akademik->semester }}
                    </option>
                  </select>
                </div>
              </div>
                ...
                <div class="col-sm-10">
                  <select class="form-control" name="mata_kuliah_id" id="mata_kuliah_id">
                    @foreach ($data_mata_kuliah as $mata_kuliah)
                      <option {{ $krs->mata_kuliah->id == $mata_kuliah->id ? 'selected' : null }} value="{{ $mata_kuliah->id }}">
                        {{ $mata_kuliah->nama_mata_kuliah }}</option>
                    @endforeach
                  </select>
                </div>
              </div>
