                ...
                <tbody>
                  @foreach ($data_tahun_akademik as $tahun_akademik)
                    <tr>
                      ...
                      <td>
                        <a href="{{ route('admin.tahun_akademik.edit', [$tahun_akademik]) }}" class="btn btn-sm btn-info"> <i class="fa fa-edit"></i>
                        </a>
                        <form onclick="return confirm('are you sure ?');" class="d-inline-block"
                          action="{{ route('admin.tahun_akademik.destroy', [$tahun_akademik]) }}" method="post">
                          @csrf
                          @method('delete')
